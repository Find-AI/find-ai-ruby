...
Documentation for released of this gem can be found [on RubyDoc](https://gemdocs.org/gems/find-ai).
...
```yaml
include:
  - 'vendor/bundle/ruby/*/gems/find-ai-*/lib/**/*.rb'
```
...
find_ai.searches.retrieve(**params)
```
