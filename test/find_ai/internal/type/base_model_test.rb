...
class FindAI::Test::PrimitiveModelTest < Minitest::Test
  A = FindAI::Internal::Type::ArrayOf[-> { Integer }]
  H = FindAI::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < FindAI::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    ...
    converters.each do |conv|
      assert_pattern do
        conv => FindAI::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [FindAI::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [FindAI::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [FindAI::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = FindAI::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        FindAI::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [FindAI::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [FindAI::Internal::Type::Boolean, true] => true,
      [FindAI::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => FindAI::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        FindAI::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = FindAI::Internal::Type::Converter.new_coerce_state
      FindAI::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        FindAI::Internal::Type::Converter.dump(target, input, state: state)
...
class FindAI::Test::EnumModelTest < Minitest::Test
  class E0
    include FindAI::Internal::Type::Enum
    attr_reader :values
...
class FindAI::Test::CollectionModelTest < Minitest::Test
  A1 = FindAI::Internal::Type::ArrayOf[-> { Integer }]
  H1 = FindAI::Internal::Type::HashOf[Integer]

  A2 = FindAI::Internal::Type::ArrayOf[H1]
  H2 = FindAI::Internal::Type::HashOf[-> { A1 }]

  A3 = FindAI::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = FindAI::Internal::Type::HashOf[Integer, nil?: true]
...
class FindAI::Test::BaseModelTest < Minitest::Test
  class M1 < FindAI::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < FindAI::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < FindAI::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, FindAI::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = FindAI::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = FindAI::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(FindAI::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue FindAI::Errors::ConversionError => e
...
class FindAI::Test::UnionTest < Minitest::Test
  class U0
    include FindAI::Internal::Type::Union
  ...
  class M2 < FindAI::Internal::Type::BaseModel
  ...
  class M4 < FindAI::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, FindAI::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < FindAI::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, FindAI::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class FindAI::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include FindAI::Internal::Type::Enum
    attr_reader :values
  ...
  def test_equality
    cases = {
      [FindAI::Internal::Type::Unknown, FindAI::Internal::Type::Unknown] => true,
      [FindAI::Internal::Type::Boolean, FindAI::Internal::Type::Boolean] => true,
      [FindAI::Internal::Type::Unknown, FindAI::Internal::Type::Boolean] => false,
...
class FindAI::Test::MetaInfoTest < Minitest::Test
  A1 = FindAI::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = FindAI::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
