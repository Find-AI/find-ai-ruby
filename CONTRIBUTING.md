...
Most of the SDK is generated code. Modifications to code will be persisted between generations, but may result in merge conflicts between manual patches and changes from the generator. The generator will never modify the contents of `lib/find_ai/helpers/` and `examples/` directory.
...
```ruby
gem "find-ai", git: "https://www.github.com/Find-AI/find-ai-ruby"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://www.github.com/Find-AI/find-ai-ruby' '<path-to-repo>'
```

```ruby
gem "find-ai", path: "<path-to-repo>"
```
