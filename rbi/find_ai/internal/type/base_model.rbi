  ...
  module Internal
    module Type
      class BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(FindAI::Internal::Type::BaseModel, FindAI::Internal::AnyHash)
          end
        ...
        class << self
          ...
          sig { params(child: FindAI::Internal::Type::BaseModel).void }
          def inherited(child)
          end
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(
                  FindAI::Internal::Type::BaseModel::KnownField,
                  {
                    type_fn:
          ...
          sig do
            override
              .params(
                value:
                  T.any(
                    FindAI::Internal::Type::BaseModel,
        ...
        class << self
          ...
          sig do
            params(
              model: FindAI::Internal::Type::BaseModel,
              convert: T::Boolean
            ).returns(FindAI::Internal::AnyHash)
          end
