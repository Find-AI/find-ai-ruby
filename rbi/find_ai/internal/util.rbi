  ...
  module Internal
    ...
    module Util
      ...
      class << self
        ...
        sig do
          params(
            data: T.any(FindAI::Internal::AnyHash, T::Array[T.anything], T.anything),
            pick: T.nilable(
              T.any(
                Symbol,
                Integer,
      ...
      class << self
        ...
        sig do
          params(lines: T::Enumerable[String]).returns(T::Enumerable[FindAI::Internal::Util::ServerSentEvent])
        end
