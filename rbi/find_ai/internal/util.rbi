      ...
      class << self
        ...
        sig do
          params(url: T.any(URI::Generic, String)).returns(
            FindAI::Internal::Util::ParsedUriShape
          )
        end
        def parse_uri(url)
        end
        ...
        # @api private
        sig do
          params(parsed: FindAI::Internal::Util::ParsedUriShape).returns(
            URI::Generic
          )
        end
        ...
        sig do
          params(
            lhs: FindAI::Internal::Util::ParsedUriShape,
            rhs: FindAI::Internal::Util::ParsedUriShape
          ).returns(URI::Generic)
        end
