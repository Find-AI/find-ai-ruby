...
module FindAI
  module Transport
    ...
    class BaseClient
        ...
        T.type_alias do
          {
            ...
            page: T.nilable(T::Class[FindAI::Type::BasePage[FindAI::BaseModel]]),
            stream: T.nilable(T::Class[T.anything]),
            model: T.nilable(FindAI::Type::Converter::Input),
      ...
      class << self
        # @api private
        sig { params(req: FindAI::Transport::BaseClient::RequestComponentsShape).void }
        def validate!(req)
        end
        ...
        sig do
          params(
            request: FindAI::Transport::BaseClient::RequestInputShape,
            status: Integer,
            response_headers: T.any(T::Hash[String, String], Net::HTTPHeader)
          )
            .returns(FindAI::Transport::BaseClient::RequestInputShape)
        end
      ...
      # @api private
      sig { returns(FindAI::Transport::PooledNetRequester) }
      ...
      sig do
        overridable
          .params(req: FindAI::Transport::BaseClient::RequestComponentsShape, opts: FindAI::Util::AnyHash)
          .returns(FindAI::Transport::BaseClient::RequestInputShape)
      end
