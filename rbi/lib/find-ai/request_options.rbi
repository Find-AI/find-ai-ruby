...
module FindAI
  ...
  module RequestParameters
    ...
    sig { returns(T.any(FindAI::RequestOptions, FindAI::Util::AnyHash)) }
    def request_options
    end

    sig do
      params(_: T.any(FindAI::RequestOptions, FindAI::Util::AnyHash))
        .returns(T.any(FindAI::RequestOptions, FindAI::Util::AnyHash))
    end
    ...
    module Converter
      # @api private
      sig { params(params: T.anything).returns([T.anything, FindAI::Util::AnyHash]) }
