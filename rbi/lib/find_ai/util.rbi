...
module FindAI
  ...
  module Util
    ...
    #   structure when using `FindAI::Util.deep_merge`.
    #
    ...
    class << self
      ...
      sig do
        params(
          data: T.any(FindAI::Util::AnyHash, T::Array[T.anything], T.anything),
    ...
    class << self
      # @api private
      sig { params(url: T.any(URI::Generic, String)).returns(FindAI::Util::ParsedUriShape) }
      def parse_uri(url)
      end

      # @api private
      sig { params(parsed: FindAI::Util::ParsedUriShape).returns(URI::Generic) }
      def unparse_uri(parsed)
      end

      # @api private
      sig do
        params(lhs: FindAI::Util::ParsedUriShape, rhs: FindAI::Util::ParsedUriShape).returns(URI::Generic)
      end
    ...
    class << self
      ...
      sig { params(lines: T::Enumerable[String]).returns(FindAI::Util::ServerSentEvent) }
