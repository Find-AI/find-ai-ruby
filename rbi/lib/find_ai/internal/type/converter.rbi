...
module FindAI
  module Internal
    module Type
      # @api private
      module Converter
        Input = T.type_alias { T.any(FindAI::Internal::Type::Converter, T::Class[T.anything]) }
        ...
        sig do
          overridable
            .params(value: T.anything, state: FindAI::Internal::Type::Converter::CoerceState)
            .returns(T.anything)
        end
        ...
        sig do
          overridable
            .params(value: T.anything, state: FindAI::Internal::Type::Converter::DumpState)
            .returns(T.anything)
        end
        ...
        class << self
              ...
              spec: T.any(
                {
                  ...
                  enum: T.nilable(T.proc.returns(FindAI::Internal::Type::Converter::Input)),
                  union: T.nilable(T.proc.returns(FindAI::Internal::Type::Converter::Input))
                },
          ...
          sig do
            params(
              target: FindAI::Internal::Type::Converter::Input,
              value: T.anything,
