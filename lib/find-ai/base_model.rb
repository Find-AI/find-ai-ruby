...
module FindAI
  ...
  module Converter
    ...
    class << self
      # @api private
      #
      # @param spec [Hash{Symbol=>Object}, Proc, FindAI::Converter, Class] .
      #
      ...
      def type_info(spec)
        ...
        in true | false
          -> { FindAI::BooleanModel }
        in FindAI::Converter | Class | Symbol
          -> { spec }
      ...
      #
      # @param target [FindAI::Converter, Class]
      #
      # @param value [Object]
      #
      ...
      def dump(target, value)
        target.is_a?(FindAI::Converter) ? target.dump(value) : FindAI::Unknown.dump(value)
      end
    end
  end
  ...
  class Unknown
    ...
    #
    # @return [Boolean]
    def self.==(other) = other.is_a?(Class) && other <= FindAI::Unknown
  ...
  module Enum
    ...
    # @return [Boolean]
    def ==(other)
      other.is_a?(Module) && other.singleton_class <= FindAI::Enum && other.values.to_set == values.to_set
    end
  ...
  module Union
    ...
    # @api private
    #
    # @param key [Symbol, Hash{Symbol=>Object}, Proc, FindAI::Converter, Class]
    #
    # @param spec [Hash{Symbol=>Object}, Proc, FindAI::Converter, Class] .
    #
    #   @option spec [NilClass, TrueClass, FalseClass, Integer, Float, Symbol] :const
    ...
    private def variant(key, spec = nil)
      variant_info =
        case key
        in Symbol
          [key, FindAI::Converter.type_info(spec)]
        in Proc | FindAI::Converter | Class | Hash
          [nil, FindAI::Converter.type_info(key)]
        end
    ...
    # @param value [Object]
    #
    # @return [FindAI::Converter, Class, nil]
    private def resolve_variant(value)
      case [@discriminator, value]
      in [_, FindAI::BaseModel]
        value.class
      in [Symbol, Hash]
        key = value.fetch(@discriminator) do
          value.fetch(@discriminator.to_s, FindAI::Util::OMIT)
        end

        return nil if key == FindAI::Util::OMIT
    ...
    # @return [Boolean]
    def ==(other)
      other.is_a?(Module) && other.singleton_class <= FindAI::Union && other.derefed_variants == derefed_variants
    end
    ...
    def coerce(value, state:)
      if (target = resolve_variant(value))
        return FindAI::Converter.coerce(target, value, state: state)
      end
      ...
      known_variants.each do |_, variant_fn|
        ...
        coerced = FindAI::Converter.coerce(target, value, state: state)
    ...
    def dump(value)
      if (target = resolve_variant(value))
        return FindAI::Converter.dump(target, value)
      end

      known_variants.each do
        target = _2.call
        return FindAI::Converter.dump(target, value) if target === value
      end
  ...
  class ArrayOf
    ...
    # @param type_info [Hash{Symbol=>Object}, Proc, FindAI::Converter, Class]
    #
    ...
    #
    # @return [Boolean]
    def ==(other) = other.is_a?(FindAI::ArrayOf) && other.nilable? == nilable? && other.item_type == item_type
      ...
      value
        .map do |item|
          ...
          in [true, nil]
            ...
            FindAI::Converter.coerce(target, item, state: state)
          end
        end
    end
    ...
    def dump(value)
      target = item_type
      value.is_a?(Array) ? value.map { FindAI::Converter.dump(target, _1) } : super
    end

    # @api private
    #
    # @return [FindAI::Converter, Class]
    ...
    def initialize(type_info, spec = {})
      @item_type_fn = FindAI::Converter.type_info(type_info || spec)
      @nilable = spec[:nil?]
    end
  end
  ...
  class HashOf
    ...
    #
    # @return [Boolean]
    def ==(other) = other.is_a?(FindAI::HashOf) && other.nilable? == nilable? && other.item_type == item_type
        ...
        .to_h do |key, val|
          ...
          v =
            ...
            in [true, nil]
              ...
              FindAI::Converter.coerce(target, val, state: state)
            end
    ...
    def dump(value)
      target = item_type
      value.is_a?(Hash) ? value.transform_values { FindAI::Converter.dump(target, _1) } : super
    end
  ...
  class BaseModel
    ...
    class << self
      ...
      private def add_field(name_sym, required:, type_info:, spec:)
        type_fn, info =
          case type_info
          in Proc | FindAI::Converter | Class
            [FindAI::Converter.type_info({**spec, union: type_info}), spec]
          in Hash
            [FindAI::Converter.type_info(type_info), type_info]
          end

        setter = "#{name_sym}="
        api_name = info.fetch(:api_name, name_sym)
        nilable = info[:nil?]
        const = required && !nilable ? info.fetch(:const, FindAI::Util::OMIT) : FindAI::Util::OMIT
        ...
        define_method(name_sym) do
          target = type_fn.call
          value = @data.fetch(name_sym) { const == FindAI::Util::OMIT ? nil : const }
          state = {strictness: :strong, exactness: {yes: 0, no: 0, maybe: 0}, branched: 0}
          (nilable || !required) && value.nil? ? nil : FindAI::Converter.coerce(target, value, state: state)
    ...
    class << self
      ...
      def coerce(value, state:)
        ...
        unless (val = FindAI::Util.coerce_hash(value)).is_a?(Hash)
          exactness[:no] += 1
          return value
        end
        exactness[:yes] += 1
        ...
        fields.each do |name, field|
          ...
          converted =
            if item.nil? && (nilable || !required)
              ...
              coerced = FindAI::Converter.coerce(target, item, state: state)
              case target
              in FindAI::Converter | Symbol
                coerced
              else
                item
              end
      ...
      def dump(value)
        unless (coerced = FindAI::Util.coerce_hash(value)).is_a?(Hash)
          return super
        end
        ...
        coerced.each do |key, val|
          ...
          in nil
            ...
            in :coerce
              ...
              target = type_fn.call
              acc.store(api_name, FindAI::Converter.dump(target, val))
            end
          end
        end
        ...
        known_fields.each_value do |field|
          ...
          next if mode == :coerce || acc.key?(api_name) || const == FindAI::Util::OMIT
    ...
    def initialize(data = {})
      case FindAI::Util.coerce_hash(data)
      in Hash => coerced
        @data = coerced
      else
