...
module FindAI
  module Resources
    class Searches
      ...
      #   @option params [Symbol, FindAI::Models::SearchCreateParams::ResultMode, nil] :result_mode The mode of the search. Valid values are 'exact' or 'best'.
      #   @option params [Symbol, FindAI::Models::SearchCreateParams::Scope, nil] :scope The scope of the search. Valid values are 'person' or 'company'.
      #
