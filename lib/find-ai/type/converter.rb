    ...
    module Converter
      ...
      class << self
        ...
        def type_info(spec)
          ...
          in true | false
            -> { FindAI::BooleanModel }
          in FindAI::Type::Converter | Class | Symbol
            -> { spec }
        ...
        #
        # @param target [FindAI::Type::Converter, Class]
        #
        # @param value [Object]
        #
        ...
        def dump(target, value)
          target.is_a?(FindAI::Type::Converter) ? target.dump(value) : FindAI::Unknown.dump(value)
        end
      end
    end
  end
