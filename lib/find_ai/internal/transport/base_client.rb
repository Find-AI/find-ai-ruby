  ...
  module Internal
    module Transport
      ...
      class BaseClient
        ...
        PLATFORM_HEADERS =
          {
            "x-stainless-arch" => FindAI::Internal::Util.arch,
            "x-stainless-lang" => "ruby",
            "x-stainless-os" => FindAI::Internal::Util.os,
        ...
        class << self
          ...
          def should_retry?(status, headers:)
            coerced = FindAI::Internal::Util.coerce_boolean(headers["x-should-retry"])
            case [coerced, status]
            in [true | false, _]
              coerced
          ...
          def follow_redirect(request, status:, response_headers:)
            ...
            location =
              Kernel.then do
                ...
                raise FindAI::Errors::APIConnectionError.new(
                  url: url,
            ...
            # from undici
            if FindAI::Internal::Util.uri_origin(url) != FindAI::Internal::Util.uri_origin(location)
          ...
          def reap_connection!(status, stream:)
            ...
            in FindAI::Errors::APIConnectionError | (500..)
              FindAI::Internal::Util.close_fused!(stream)
            else
            end
          end
        end
        ...
        # @api private
        # @return [FindAI::Internal::Transport::PooledNetRequester]
        ...
        def initialize(
          ...
          @requester = FindAI::Internal::Transport::PooledNetRequester.new
          @headers = FindAI::Internal::Util.normalized_headers(
          ...
          @base_url_components = FindAI::Internal::Util.parse_uri(base_url)
          @base_url = FindAI::Internal::Util.unparse_uri(@base_url_components)
        ...
        #
        # @return [String]
        private def user_agent = "#{self.class.name}/Ruby #{FindAI::VERSION}"
        ...
        private def build_request(req, opts)
          ...
          path = FindAI::Internal::Util.interpolate_path(uninterpolated_path)

          query = FindAI::Internal::Util.deep_merge(req[:query].to_h, opts[:extra_query].to_h)
          ...
          body =
            ...
            in :get | :head | :options | :trace
              ...
              FindAI::Internal::Util.deep_merge(*[req[:body], opts[:extra_body]].compact)
            end
          ...
          url = FindAI::Internal::Util.join_parsed_uri(
            @base_url_components,
            {**req, path: path, query: query}
          )
          headers, encoded = FindAI::Internal::Util.encode_content(headers, body)
          {
            method: method,
            url: url,
            headers: headers,
        ...
        def send_request(request, redirect_count:, retry_count:, send_retry_header:)
          ...
          input = {**request.except(:timeout), deadline: FindAI::Internal::Util.monotonic_secs + timeout}
          ...
          rescue FindAI::Errors::APIConnectionError => e
            status = e
          end
          headers = FindAI::Internal::Util.normalized_headers(response&.each_header&.to_h)
          ...
          in 300..399 if redirect_count >= self.class::MAX_REDIRECTS
            ...
            raise FindAI::Errors::APIConnectionError.new(url: url, response: response, message: message)
          in 300..399
            self.class.reap_connection!(status, stream: stream)
          ...
          in FindAI::Errors::APIConnectionError if retry_count >= max_retries
            raise status
          in (400..) if retry_count >= max_retries || !self.class.should_retry?(status, headers: headers)
            decoded = Kernel.then do
              FindAI::Internal::Util.decode_content(headers, stream: stream, suppress_error: true)
            ensure
              self.class.reap_connection!(status, stream: stream)
            end
        ...
        #
        # @param options [FindAI::RequestOptions, Hash{Symbol=>Object}, nil] .
        #
        ...
        def request(req)
          ...
          model = req.fetch(:model) { FindAI::Internal::Type::Unknown }
          opts = req[:options].to_h
          unwrap = req[:unwrap]
          FindAI::RequestOptions.validate!(opts)
          ...
          headers = FindAI::Internal::Util.normalized_headers(response.each_header.to_h)
          decoded = FindAI::Internal::Util.decode_content(headers, stream: stream)
          case req
          in {stream: Class => st}
            st.new(
              model: model,
          ...
          in {page: Class => page}
            ...
            unwrapped = FindAI::Internal::Util.dig(decoded, unwrap)
            FindAI::Internal::Type::Converter.coerce(model, unwrapped)
          end
        end
          ...
          T.type_alias do
            {
              ...
              options: T.nilable(FindAI::RequestOptions::OrHash)
            }
          end
        end
