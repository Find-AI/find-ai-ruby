    ...
    module Type
      ...
      class BaseModel
        ...
        class << self
          ...
          #
          # @param child [Class<FindAI::Internal::Type::BaseModel>]
          def inherited(child)
            super
          ...
          private def add_field(name_sym, required:, type_info:, spec:)
            meta = FindAI::Internal::Type::Converter.meta_info(type_info, spec)
            type_fn, info =
              case type_info
              in Proc | FindAI::Internal::Type::Converter | Class
                [FindAI::Internal::Type::Converter.type_info({**spec, union: type_info}), spec]
              in Hash
                [FindAI::Internal::Type::Converter.type_info(type_info), type_info]
              end
            ...
            define_method(setter) do |value|
              target = type_fn.call
              state = FindAI::Internal::Type::Converter.new_coerce_state(translate_names: false)
              coerced = FindAI::Internal::Type::Converter.coerce(target, value, state: state)
              status = @coerced.store(name_sym, state.fetch(:error) || true)
              stored =
                case [target, status]
                in [FindAI::Internal::Type::Converter | Symbol, true]
                  coerced
                else
                  value
                end
            ...
            define_method(name_sym) do
              ...
              in true | false if FindAI::Internal::Type::Converter === target
                @data.fetch(name_sym)
              in ::StandardError => e
                raise FindAI::Errors::ConversionError.new(
                  on: self.class,
                  method: __method__,
                  target: target,
                ...
                Kernel.then do
                  ...
                  if (nilable || !required) && value.nil?
                    ...
                    FindAI::Internal::Type::Converter.coerce(
        ...
        class << self
          ...
          def coerce(value, state:)
            ...
            unless (val = FindAI::Internal::Util.coerce_hash(value)).is_a?(Hash)
              exactness[:no] += 1
            ...
            fields.each do |name, field|
              ...
              converted =
                if item.nil? && (nilable || !required)
                  ...
                  coerced = FindAI::Internal::Type::Converter.coerce(target, item, state: state)
                  case target
                  in FindAI::Internal::Type::Converter | Symbol
                    coerced
                  else
                    item
                  end
          ...
          def dump(value, state:)
            unless (coerced = FindAI::Internal::Util.coerce_hash(value)).is_a?(Hash)
              return super
            end
            ...
            coerced.each do |key, val|
              ...
              in nil
                ...
                in :coerce
                  ...
                  target = type_fn.call
                  acc.store(api_name, FindAI::Internal::Type::Converter.dump(target, val, state: state))
                end
              end
            end
            ...
            rec = ->(x) do
              ...
              in FindAI::Internal::Type::BaseModel
                if convert
                  ...
                  rescue FindAI::Errors::ConversionError
                    [key, rec.call(val)]
                  end
                else
                  rec.call(x.to_h)
        ...
        #
        # @return [String]
        def to_json(*a) = FindAI::Internal::Type::Converter.dump(self.class, self).to_json(*a)
        ...
        #
        # @return [String]
        def to_yaml(*a) = FindAI::Internal::Type::Converter.dump(self.class, self).to_yaml(*a)
        ...
        def initialize(data = {})
          @data = {}
          @coerced = {}
          FindAI::Internal::Util.coerce_hash!(data).each do
        ...
        class << self
          ...
          def inspect(depth: 0)
            ...
            deferred = fields.transform_values do |field|
              ...
              inspected = [
                FindAI::Internal::Type::Converter.inspect(type, depth: depth),
