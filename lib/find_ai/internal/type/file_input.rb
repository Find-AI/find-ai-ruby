...
module FindAI
  module Internal
    module Type
      ...
      # `FindAI::Internal::Type::FileInput`.
      #
      ...
      class FileInput
        ...
        def self.===(other)
          case other
          in Pathname | StringIO | IO | String | FindAI::FilePart
            true
          else
            false
          end
        ...
        #
        # @return [Boolean]
        def self.==(other) = other.is_a?(Class) && other <= FindAI::Internal::Type::FileInput
        ...
        class << self
          ...
          def dump(value, state:)
            ...
            in StringIO | String
              ...
              FindAI::FilePart.new(value, filename: "upload")
            in IO
              state[:can_retry] = false
              value.to_path.nil? ? FindAI::FilePart.new(value, filename: "upload") : value
            in FindAI::FilePart if value.content.is_a?(IO)
              state[:can_retry] = false
              value
            else
              value
