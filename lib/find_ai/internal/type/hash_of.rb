    ...
    module Type
      ...
      class HashOf
        ...
        def ==(other)
          ...
          other.is_a?(FindAI::Internal::Type::HashOf) && other.nilable? == nilable? && other.item_type == item_type
            ...
            .to_h do |key, val|
              ...
              v =
                ...
                in [true, nil]
                  ...
                  FindAI::Internal::Type::Converter.coerce(target, val, state: state)
                end
        ...
        def dump(value, state:)
          ...
          if value.is_a?(Hash)
            value.transform_values do
              FindAI::Internal::Type::Converter.dump(target, _1, state: state)
            end
          else
            super
          end
        ...
        # @return [String]
        def inspect(depth: 0)
          items = FindAI::Internal::Type::Converter.inspect(item_type, depth: depth.succ)
