    ...
    class PooledNetRequester
      ...
      class << self
        ...
        def calibrate_socket_timeout(conn, deadline)
          timeout = deadline - FindAI::Util.monotonic_secs
        ...
        def build_request(request, &blk)
          ...
          in String
            ...
            req.body_stream = FindAI::Util::ReadIOAdapter.new(body, &blk)
          in StringIO
      ...
      private def with_pool(url, deadline:, &blk)
        origin = FindAI::Util.uri_origin(url)
        timeout = deadline - FindAI::Util.monotonic_secs
        pool =
      ...
      def execute(request)
        ...
        body = FindAI::Util.fused_enum(enum, external: true) do
          finished = true
          tap do
            enum.next
