    ...
    class BaseClient
      ...
      class << self
        ...
        def should_retry?(status, headers:)
          coerced = FindAI::Util.coerce_boolean(headers["x-should-retry"])
          case [coerced, status]
          in [true | false, _]
            coerced
        ...
        def follow_redirect(request, status:, response_headers:)
          ...
          # from undici
          if FindAI::Util.uri_origin(url) != FindAI::Util.uri_origin(location)
      ...
      # @api private
      # @return [FindAI::Transport::PooledNetRequester]
      ...
      def initialize(
        ...
        @requester = FindAI::Transport::PooledNetRequester.new
        ...
        @base_url = FindAI::Util.parse_uri(base_url)
      ...
      #
      #   @option req [FindAI::Type::Converter, Class, nil] :model
      #
      ...
      private def build_request(req, opts)
        ...
        path = FindAI::Util.interpolate_path(uninterpolated_path)

        query = FindAI::Util.deep_merge(req[:query].to_h, opts[:extra_query].to_h)
        ...
        body =
          ...
          in :get | :head | :options | :trace
            ...
            FindAI::Util.deep_merge(*[req[:body], opts[:extra_body]].compact)
          end

        headers, encoded = FindAI::Util.encode_content(headers, body)
        {
          method: method,
          url: FindAI::Util.join_parsed_uri(@base_url, {**req, path: path, query: query}),
          headers: headers,
          body: encoded,
      ...
      private def send_request(request, redirect_count:, retry_count:, send_retry_header:)
        ...
        input = {**request.except(:timeout), deadline: FindAI::Util.monotonic_secs + timeout}
        ...
        in (400..) if retry_count >= max_retries || !self.class.should_retry?(status, headers: response)
          decoded = Kernel.then do
            FindAI::Util.decode_content(response, stream: stream, suppress_error: true)
          ensure
            self.class.reap_connection!(status, stream: stream)
          end
      ...
      def request(req)
        ...
        decoded = FindAI::Util.decode_content(response, stream: stream)
        case req
        in { stream: Class => st }
        ...
        in { page: Class => page }
          ...
          unwrapped = FindAI::Util.dig(decoded, req[:unwrap])
          FindAI::Type::Converter.coerce(model, unwrapped)
        end
      end
      ...
      def inspect
        ...
        base_url = FindAI::Util.unparse_uri(@base_url)
